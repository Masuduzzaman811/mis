                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="col-md-10">
                                <a href="javascript:void(0)" class="btn btn-block btn-default">Course List</a><br>
                                <table id="table" class="table table-responsive table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT course.*, teacher.* FROM course LEFT JOIN teacher ON course.courseTeacher=teacher.teacherId";
                                        ...
                                        if ($checkRow > 0):
                                            while ($obj = mysqli_fetch_object($runSql)):
                                                ?>
                                                <tr>
                                                    <td><?php echo $obj->courseId; ?></td>
                                                    <td><?php echo $obj->courseName; ?></td>
                                                    <td><?php echo $obj->teacherName; ?></td>
                                                    <td><?php echo $obj->courseCredit; ?></td>
                                                    <td><?php echo $obj->courseGrade; ?></td>
                                                    <td><?php echo $obj->courseCanceledYear; ?></td>
                                                    <td>
                                                        <a href="course_edit.php?id=<?php echo $obj->courseId; ?>" class="btn btn-default btn-xs">Edit</a>
                                                        <a href="delete.php?type=Course&id=<?php echo $obj->courseId; ?>" class="btn btn-default btn-xs">Delete</a>
                                                        <a href="assign_course.php?id=<?php echo $obj->courseId; ?>" class="btn btn-default btn-xs">Assign</a>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
                                        <?php else: ?>
                                            <tr>
                                                <td style="text-align: center;"colspan="7">No data found in table</td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                    <tfoot>
