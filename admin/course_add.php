...
if (isset($_POST['btnSubmit'])) {
    ...
    if (!is_numeric($courseId)) {
        ...
        $sql = "INSERT INTO course (courseId, courseName, courseTeacher, courseCredit, courseGrade, courseCanceledYear) "
                . "VALUES ('" . $courseId . "', '" . $courseName . "','" . $courseTeacher . "', '" . $courseCredit . "', '" . $courseGrade . "', '" . $courseCanceledYear . "')";
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="col-md-10">
                                <a href="javascript:void(0)" class="btn btn-block btn-default">Add New Course</a><br>
                                <p style="color: red"><?php echo $error; ?></p>
                                <form method="POST" action="">
                                    <div class="form-group">
                                        <label>Course Id</label>
                                        <input type="text" maxlength="7"  class="form-control" name="courseId" value="<?php echo $courseId; ?>" placeholder="Enter course id" required/>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="courseTeacher" required>
                                            ...
                                            if ($teacherRunSql):
                                                while ($obj = mysqli_fetch_object($teacherRunSql)):
                                                    ?>
                                                    <option value="<?php echo $obj->teacherId; ?>"><?php echo $obj->teacherName; ?></option>
                                                <?php endwhile; ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
